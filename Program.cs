...
namespace Inheritance
{
    ...
    class PlayerCharacter
    {
        ...
        public void SetAc(int ac) { _ac = ac; }

        public virtual void addChange()
        {
            Console.Write("Level: ");
            SetLevel(int.Parse(Console.ReadLine()));
            Console.Write("Hitpoints: ");
            SetHp(int.Parse(Console.ReadLine()));
            Console.Write("Armor Class: ");
            SetAc(int.Parse(Console.ReadLine()));
        }
    ...
    class Barbarian : PlayerCharacter
    {
        ...
        public int GetRage(int rage) { return _rage; }
        public string GetWeapon() { return _weapon; }
        public void SetRage(int rage) { _rage = rage; }
        ...
        public override void addChange()
        {
            ...
            SetRage(int.Parse(Console.ReadLine()));
            Console.Write("Weapon of Choice: ");
            SetWeapon(Console.ReadLine());
        }
